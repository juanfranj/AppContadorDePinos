...
# Con esta configuración dentro de cd buildozer funciona.
# con buildozer appclean se borra el .buildozer y se puede empezar 
# sudo apt update
...
# https://www.youtube.com/watch?v=cuyWeS4CY5o
# https://www.youtube.com/watch?v=cuyWeS4CY5o
[app]
...
# (str) Package name
package.name = AppContadorPinos

# (str) Package domain (needed for android/ios packaging)
package.domain = org.ContadorPinos
...
presplash.filename = images/portada.png

# (str) Icon of the application
icon.filename = images/icono.png
